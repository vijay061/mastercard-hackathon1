...
function PanEligibilityService(consumerKey, privateKey, environment, callback){
    ...
    this.getPanEligibility = function(request){
        var body = request;
        var url = this.getUrl();
...
module.exports.PanEligibilityService = PanEligibilityService;
