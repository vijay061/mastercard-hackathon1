...
const PRODUCTION_URL = 'https://api.mastercard.com/atms/v1/countrysubdivision?Format=XML';
const SANDBOX_URL = 'https://sandbox.api.mastercard.com/atms/v1/countrysubdivision?Format=XML';

function CountrySubdivisionAtmLocationService(consumerKey, privateKey, environment, callback){
...
module.exports.CountrySubdivisionAtmLocationService = CountrySubdivisionAtmLocationService;
