...
const PRODUCTION_URL = 'https://api.mastercard.com/merchants/v1/countrysubdivision?Format=XML';
const SANDBOX_URL = 'https://sandbox.api.mastercard.com/merchants/v1/countrysubdivision?Format=XML';

function CountrySubdivisionMerchantLocationService(consumerKey, privateKey, environment, callback){
...
module.exports.CountrySubdivisionMerchantLocationService = CountrySubdivisionMerchantLocationService;
