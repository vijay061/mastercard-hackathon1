...
const PRODUCTION_URL = 'https://api.mastercard.com/restaurants/v1/restaurant?Format=XML';
const SANDBOX_URL = 'https://sandbox.api.mastercard.com/restaurants/v1/restaurant?Format=XML';

function RestaurantsLocalFavoritesService(consumerKey, privateKey, environment, callback){
    ...
    this.getRestaurants = function(options){
...
module.exports.RestaurantsLocalFavoritesService = RestaurantsLocalFavoritesService;
